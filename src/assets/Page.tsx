  ...
  return (
    <div>
      <section className="landing">
        ...
        <img src="/src/assets/me.jpg" alt="my image" className="my-image "/>
      </section>
      <div id="about"></div>
      <section className="about-me">
        ...
        <div className="me-block">
            <div className="some-container">
              <img src="/src/assets/also_me.jpg" alt="my image" className="my-image my-image-2"/>
            </div>
            <div className="me-right">
                ...
                <p className="me-right-block color-2">
                    ...
                    Online shopping, Game catalog, Audio player, <br />
                ...
                <a href="#"><div className="hello-btn">
                  Contact Me
